...
class HashTable():
    ...
    def insert(self,value):
        ...
        home = value
        i = 0
        while(self.values[(home+i)%m]!=None):
            i+=1
        self.values[(home+i)%m] = value
        self.size+=1
    ...
    def contains(self,value):
        ...
        home = value
        i = 0
        while(self.values[(home+i)%m]!=value):
            if(c==self.size):
                return print ("False")
            i+=1
            c+=1
...
collList = [19, 24, 36, 34, 45, 51, 64, 81, 82, 75, 119, 113, 125, 130, 165, 183, 193] #Sequence which is not random(I decided some values)
